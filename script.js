...
function applyDarkMode(){document.documentElement.classList.toggle('dark-mode',state.darkMode);const t=document.getElementById('darkToggle');if(t)t.classList.toggle('on',state.darkMode);try{if(window.Android){Android.setStatusBar('#FFFFFF',true)}}catch(e){}}
